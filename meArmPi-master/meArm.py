...
class meArm():
    value = 0
    def __init__(self,
            sweepMinBase     = 102, sweepMaxBase     = 505, angleMinBase     =   1.52, angleMaxBase     = -1.55,
            sweepMinShoulder = 143, sweepMaxShoulder = 471, angleMinShoulder =   2.58, angleMaxShoulder =  0.37,
            sweepMinElbow    = 292, sweepMaxElbow    = 123, angleMinElbow    =   0.44, angleMaxElbow    = -0.87,
            sweepMinGripper  = 328, sweepMaxGripper  = 82, angleMinGripper  =   -0.79, angleMaxGripper  =  1.75):
